...
//                 wingGeom,
//                 new THREE.MeshPhongMaterial({ color: 0xA07D5A, side: THREE.DoubleSide })
//             );
...
//         // Procedural Clouds construction
...
//         }
//         // Lighting
//         const hemisphereLight = new THREE.HemisphereLight(0xd4c4b0, 0x8a7d6b, 0.8);
...
//         // Select timeline elements to apply transform origins
//         gsap.set('.timeline__item', { transformOrigin: '0% 100%' });
//         gsap.set('.timeline__item:nth-child(even)', { transformOrigin: '100% 100%' });
//         gsap.set('.timeline__image', { transformOrigin: '50% 100%' });
//         // Odd items animation (scrub)
//         gsap.utils.toArray('.timeline__item:nth-child(odd)').forEach((item) => {
//             gsap.fromTo(
//                 item,
//                 { y: 100, scale: 0.5 },
//                 {
...
//             );
//         });
//         // Even items animation (scrub)
//         gsap.utils.toArray('.timeline__item:nth-child(even)').forEach((item) => {
//             gsap.fromTo(
//                 item,
//                 { y: -100, scale: 0.5 },
//                 {
...
//             );
//         });
//         // Background Image Scale on scroll scrub
//         gsap.fromTo(
//             '.timeline__image',
//             { scaleY: 1.8 },
//             {
...
//             }
//         );
//         // Date text reveal offset transition
//         gsap.fromTo(
//             '.timeline__text--offset',
//             { y: 130 },
//             {
//                 y: 0,
//                 scrollTrigger: {
...
//             }
//         );
//         // Short bronze bottom line width expansion
//         gsap.fromTo(
//             '.timeline__line',
//             { scaleX: 0 },
//             {
